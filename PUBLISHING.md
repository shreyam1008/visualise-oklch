...
Marketplace remains at 2.0.5 with no `VSCE_PAT` or federated publisher identity configured. Its upload dialog is ready for the owner to select the released 2.1.0 VSIX. The earlier authentication audit below is historical and superseded for Open VSX only.
